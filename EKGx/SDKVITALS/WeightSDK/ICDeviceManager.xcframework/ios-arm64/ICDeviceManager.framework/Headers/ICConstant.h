...
typedef NS_ENUM(NSUInteger, ICRulerBodyPartsType)
{
     ...
     * 颈
     */
    ICRulerPartsTypeNeck,
    /**
     * 手臂 - 左手臂
     */
    ICRulerPartsTypeBicepL,
    /**
     * 大腿 - 左
     */
    ICRulerPartsTypeThighL,
    
    /**
     * 小腿 - 左
     */
    ICRulerPartsTypeCalfL,
    
    /**
     * 头
     */
    ICRulerPartsTypeHead,
...
typedef NS_ENUM(NSUInteger, ICDeviceFunction) {
     ...
     * 是否支持心跳包
     */
    ICDeviceFunctionSupportHeartbeatPacket,
    /*
     * 是否支持ECG
     */
    ICDeviceFunctionSupportECG,
