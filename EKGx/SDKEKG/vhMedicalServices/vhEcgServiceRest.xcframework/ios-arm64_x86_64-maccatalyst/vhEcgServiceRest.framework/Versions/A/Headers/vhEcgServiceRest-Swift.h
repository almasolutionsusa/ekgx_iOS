...
#ifndef VHECGSERVICEREST_SWIFT_H
#define VHECGSERVICEREST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="vhEcgServiceRest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_CLASS("_TtC16vhEcgServiceRest14AnalysisResult")
...
SWIFT_CLASS("_TtC16vhEcgServiceRest8Analyzer")
...
SWIFT_CLASS("_TtC16vhEcgServiceRest8PickInfo")
@interface PickInfo : NSObject
/// Set Data for Gesture
/// \param I Array of Lead I, short
///
/// \param II Array of Lead II, short
///
/// \param pos The positions of all beats, long
///
/// \param fs Sampling Rate of data
///
- (BOOL)setDataWithI:(NSArray<NSNumber *> * _Nonnull)I II:(NSArray<NSNumber *> * _Nonnull)II pos:(NSArray<NSNumber *> * _Nonnull)pos fs:(int16_t)fs SWIFT_WARN_UNUSED_RESULT;
/// Get QRS Axis between two fingers.
/// \param pos1 the position of left finger
///
/// \param pos2 the positions of right finger
///
///
/// returns:
///
/// QRS axis in degree
- (float)QRSaxisWithPos1:(int32_t)pos1 pos2:(int32_t)pos2 SWIFT_WARN_UNUSED_RESULT;
...
- (int16_t)hrWithPos1:(int32_t)pos1 pos2:(int32_t)pos2 SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
